...
public class Student {
	...
	*/
	...
	// 파라미터로 학생들을 받아서 학점이 "F" 인 학생들만 출력해주는 메소드임.
	...
	}// end of static void failStudent(Student[] studentArr)--------------
	
	
	// 파라미터로 학생들을 받아서 학점이 "A" 인 학생들만 이름을 변경하여 
	// 학생들(배열)을 리턴시켜주는 메소드임.(변경된 새로운 학생들의 정보(배열)를 돌려주는것)
