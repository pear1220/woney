...
public class ArrayTest1 {
	...
	public static void main(String[] args) {
		...
		// 2). 메모리에 할당을 해준다.
		   ...
		   // 정수는 0, 실수는 0.0, String 을 포함한 객체는 null 이 들어간다.
		/*
		   ------------------------------
		   | 0 | 1 | 2 | 3 | 4 | 5 | 6 |  
		   ------------------------------
		 위의 숫자는 배열의 인덱스를 가리키는 번호로서 0 부터 시작하여 1씩 증가한다.
	...
	*/
		...
		for(int val : course2) { // 배열의 길이만큼 자동적으로 반복한 후 빠져 나간다.
			total += val;
		}
