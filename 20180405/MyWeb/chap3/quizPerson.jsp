...
<meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- 인터넷을 사용안한 경우 --> 
  <link rel="stylesheet" href="<%= request.getContextPath() %>/bootstrap-3.3.7-dist/css/bootstrap.min.css"> <%-- bootstrap을 사용하기 위해서 경로를 <%= request.getContextPath() %>지정해준다. --%>
...
<script type="text/javascript">
	...
	/*
		...
		jjm.png /jjbong.png / tangsy.png/ yang.png/ palvc.png
	*/
</script>
</head>
<body>
...
<!-- Form Name -->
<legend><h2 class="text-info">개인 취향테스트(GET/POST)</h2></legend>
